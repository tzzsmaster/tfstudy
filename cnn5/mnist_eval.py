...
卷积神经网络LeNet-5 测试程序 mnist_eval.py
"""
import time
import tensorflow as tf
from tensorflow.examples.tutorials.mnist import input_data

from cnn5 import mnist_inference, mnist_train
    ...
    with tf.Graph().as_default() as g:
        ...
        while True:
            with tf.Session(config=config) as sess:
                ...
                # print(ckpt)
                # model_checkpoint_path: "/path/to/model/cnn5/model.ckpt-4001"
                # all_model_checkpoint_paths: "/path/to/model/cnn5/model.ckpt-1"
                # all_model_checkpoint_paths: "/path/to/model/cnn5/model.ckpt-1001"
                # all_model_checkpoint_paths: "/path/to/model/cnn5/model.ckpt-2001"
                # all_model_checkpoint_paths: "/path/to/model/cnn5/model.ckpt-3001"
                # all_model_checkpoint_paths: "/path/to/model/cnn5/model.ckpt-4001"
